...
from code.db.utils import create_database, drop_database
from code.settings import settings
from code.web.application import get_app
...
async def _engine(anyio_backend: Any) -> AsyncGenerator[AsyncEngine]:
    ...
    :yield: new engine.
    """
    from code.db.meta import meta
    from code.db.models import load_all_models
